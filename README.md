...
## DB Assignments [![Build Status](https://travis-ci.org/superpuper777/db-assignments.svg?branch=master)](https://travis-ci.org/superpuper777/db-assignments)
...
- Edit local README.md file and update all links (just replace all occurrences of `'superpuper777'` with your account name).
...
- Push your updates to github server and check if tests passed on [travis-ci](https://travis-ci.org/superpuper777/db-assignments/builds).
